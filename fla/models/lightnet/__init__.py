...
paddleformers.transformers.AutoConfig.register(LightNetConfig.model_type, LightNetConfig,
                                               exist_ok=True)
paddleformers.transformers.AutoModel.register(LightNetConfig, LightNetModel, exist_ok=True)
paddleformers.transformers.AutoModelForCausalLM.register(LightNetConfig,
                                                         LightNetForCausalLM, exist_ok=True)
