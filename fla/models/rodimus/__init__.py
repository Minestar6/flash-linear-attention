...
paddleformers.transformers.AutoConfig.register(RodimusConfig.model_type, RodimusConfig,
                                               exist_ok=True)
paddleformers.transformers.AutoModel.register(RodimusConfig, RodimusModel, exist_ok=True)
paddleformers.transformers.AutoModelForCausalLM.register(RodimusConfig,
                                                         RodimusForCausalLM, exist_ok=True)
