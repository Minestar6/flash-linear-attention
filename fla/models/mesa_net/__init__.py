...
paddleformers.transformers.AutoConfig.register(MesaNetConfig.model_type, MesaNetConfig,
                                               exist_ok=True)
paddleformers.transformers.AutoModel.register(MesaNetConfig, MesaNetModel, exist_ok=True)
paddleformers.transformers.AutoModelForCausalLM.register(MesaNetConfig,
                                                         MesaNetForCausalLM, exist_ok=True)
