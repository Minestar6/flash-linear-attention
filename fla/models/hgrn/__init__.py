...
paddleformers.transformers.AutoConfig.register(HGRNConfig.model_type, HGRNConfig,
    exist_ok=True)
paddleformers.transformers.AutoModel.register(HGRNConfig, HGRNModel, exist_ok=True)
paddleformers.transformers.AutoModelForCausalLM.register(HGRNConfig, HGRNForCausalLM,
    exist_ok=True)
