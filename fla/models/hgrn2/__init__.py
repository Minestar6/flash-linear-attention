...
paddleformers.transformers.AutoConfig.register(HGRN2Config.model_type, HGRN2Config,
    exist_ok=True)
paddleformers.transformers.AutoModel.register(HGRN2Config, HGRN2Model, exist_ok=True)
paddleformers.transformers.AutoModelForCausalLM.register(HGRN2Config, HGRN2ForCausalLM,
    exist_ok=True)
