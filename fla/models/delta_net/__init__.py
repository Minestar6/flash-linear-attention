...
paddleformers.transformers.AutoConfig.register(DeltaNetConfig.model_type, DeltaNetConfig,
    exist_ok=True)
paddleformers.transformers.AutoModel.register(DeltaNetConfig, DeltaNetModel, exist_ok=True)
paddleformers.transformers.AutoModelForCausalLM.register(DeltaNetConfig,
    DeltaNetForCausalLM, exist_ok=True)
