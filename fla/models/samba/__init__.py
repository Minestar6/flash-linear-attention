...
paddleformers.transformers.AutoConfig.register(SambaConfig.model_type, SambaConfig,
    exist_ok=True)
paddleformers.transformers.AutoModel.register(SambaConfig, SambaModel, exist_ok=True)
paddleformers.transformers.AutoModelForCausalLM.register(SambaConfig, SambaForCausalLM,
    exist_ok=True)
