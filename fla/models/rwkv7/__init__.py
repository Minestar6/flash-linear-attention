...
paddleformers.transformers.AutoConfig.register(RWKV7Config.model_type, RWKV7Config,
                                               exist_ok=True)
paddleformers.transformers.AutoModel.register(RWKV7Config, RWKV7Model, exist_ok=True)
paddleformers.transformers.AutoModelForCausalLM.register(RWKV7Config, RWKV7ForCausalLM,
                                                         exist_ok=True)
