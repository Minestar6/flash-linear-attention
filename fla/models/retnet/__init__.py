...
paddleformers.transformers.AutoConfig.register(RetNetConfig.model_type, RetNetConfig,
                                               exist_ok=True)
paddleformers.transformers.AutoModel.register(RetNetConfig, RetNetModel, exist_ok=True)
paddleformers.transformers.AutoModelForCausalLM.register(RetNetConfig, RetNetForCausalLM,
                                                         exist_ok=True)
