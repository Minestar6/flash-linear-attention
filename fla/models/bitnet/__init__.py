...
paddleformers.transformers.AutoConfig.register(BitNetConfig.model_type, BitNetConfig,
    exist_ok=True)
paddleformers.transformers.AutoModel.register(BitNetConfig, BitNetModel, exist_ok=True)
paddleformers.transformers.AutoModelForCausalLM.register(BitNetConfig, BitNetForCausalLM,
    exist_ok=True)
