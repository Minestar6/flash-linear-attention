...
paddleformers.transformers.AutoConfig.register(MambaConfig.model_type, MambaConfig,
                                               exist_ok=True)
paddleformers.transformers.AutoModel.register(MambaConfig, MambaModel, exist_ok=True)
paddleformers.transformers.AutoModelForCausalLM.register(MambaConfig, MambaForCausalLM,
                                                         exist_ok=True)
