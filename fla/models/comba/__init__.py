...
paddleformers.transformers.AutoConfig.register(CombaConfig.model_type, CombaConfig,
                                               exist_ok=True)
paddleformers.transformers.AutoModel.register(CombaConfig, CombaModel, exist_ok=True)
paddleformers.transformers.AutoModelForCausalLM.register(CombaConfig, CombaForCausalLM,
                                                         exist_ok=True)
