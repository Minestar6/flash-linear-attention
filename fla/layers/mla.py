    ...
    def forward(
        ...
        **kwargs,
        ...
        if attention_mask is not None:
            ...
            o = paddle.nn.functional.flash_attention.flash_attn_unpadded(q, k, v, cu_seqlens_q=
                cu_seqlens_q, cu_seqlens_k=cu_seqlens_k, max_seqlen_q=
                max_seqlen_q, max_seqlen_k=max_seqlen_k, scale=self.scaling, causal=True)[0]
            ...
            o = paddle.nn.functional.flash_attention.flash_attn_unpadded(q.squeeze(0), k.squeeze(0
                ...
                max_seqlen, scale=self.scaling, causal=True)[0].unsqueeze(0)
        else:
